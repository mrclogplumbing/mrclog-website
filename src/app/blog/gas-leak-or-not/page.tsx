...
export const metadata: Metadata = {
  title: pageTitle("Gas Leak or Not? How to Tell — and What to Do"),
  description:
...
const tocItems = [
  { id: "signs", title: "Signs of a Gas Leak" },
  { id: "what-to-do", title: "What to Do — 8 Steps" },
  { id: "what-not-to-do", title: "What NOT to Do" },
  { id: "causes", title: "Common Causes" },
  { id: "safety-checks", title: "Regular Safety Checks" },
  { id: "faq", title: "FAQs" },
];
    ...
    <>
        ...
        <div className="relative section-container py-12 md:py-18">
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold px-3 py-1 rounded-full" style={{ background: "rgba(26,159,255,0.2)", color: "var(--color-brand-blue-bright)" }}>Gas Safety</span>
      ...
      <div className="section-container py-14 md:py-20">
        <div className="lg:grid lg:grid-cols-[1fr_220px] lg:gap-12 max-w-5xl mx-auto">
          ...
          <article>
            {/* Safety alert */}
            <div className="rounded-2xl p-5 mb-6 border-l-4" style={{ background: "#fdecea", borderColor: "#c0392b" }}>
            ...
            <div className="rounded-2xl p-6 mb-10 border-l-4" style={{ background: "var(--color-brand-blue-light)", borderColor: "var(--color-brand-blue)" }}>
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                If you can smell gas indoors, treat it as a real leak until proven otherwise. Don&rsquo;t touch any switches — get everyone out, leave doors and windows open as you go, and call your gas provider&rsquo;s emergency line or 000 from outside.
              </p>
            </div>

            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p>Gas is one of the safest and most reliable energy sources for Australian homes — but like anything, it requires respect. Most people will never experience a gas leak in their lifetime. But if you ever do, knowing how to react quickly and calmly is what keeps it from becoming a serious incident.</p>

              <hr className="border-gray-200 my-8" />

              <h2 id="signs" className="font-logo font-bold text-2xl mb-4" style={{ color: "var(--color-dark)" }}>Signs You Might Have a Gas Leak</h2>

              <h3 className="font-logo font-bold text-lg mb-2" style={{ color: "var(--color-dark)" }}>The smell of rotten eggs or sulphur</h3>
              <p>Natural gas is odourless by itself, so gas companies add a chemical called mercaptan — a deliberately unpleasant smell, similar to rotten eggs or sulphur. If you notice this smell anywhere in or around your home, even faintly, take it seriously.</p>
              ...
              <p>A hissing or soft whistling sound near your gas meter, a gas pipe, your stove, heater, or hot water system can indicate gas escaping under pressure. Even a faint hiss in an otherwise quiet room is worth investigating.</p>
              ...
              <p>If a patch of garden near an underground gas line is dying without obvious reason, gas escaping from the soil may be depriving the roots of oxygen. A telltale sign of a slow underground leak.</p>
              ...
              <p>Gas bubbling up through puddles or wet soil near your gas meter is a serious warning sign. Report this to your gas distributor immediately.</p>

              <h3 className="font-logo font-bold text-lg mb-2 mt-6" style={{ color: "var(--color-dark)" }}>Physical symptoms in people or pets</h3>
              <p>Exposure to leaking gas can cause headaches, dizziness, nausea, and eye or throat irritation. If symptoms ease once you go outside, gas could be the cause. Pets may also seem lethargic or disoriented.</p>

              <hr className="border-gray-200 my-8" />

              <h2 id="what-to-do" className="font-logo font-bold text-2xl mb-4" style={{ color: "var(--color-dark)" }}>What to Do Immediately — 8 Steps</h2>
              <ol className="space-y-3 list-decimal pl-5 text-sm mt-2">
                {[
              ...
              <h2 id="what-not-to-do" className="font-logo font-bold text-2xl mb-4" style={{ color: "var(--color-dark)" }}>What NOT to Do During a Gas Leak</h2>
              ...
              <h2 id="causes" className="font-logo font-bold text-2xl mb-4" style={{ color: "var(--color-dark)" }}>Common Causes of Gas Leaks at Home</h2>
              ...
              <p>Gas cooktops, heaters, and hot water systems connect to the gas supply via flexible hoses or fittings. These can loosen, crack, or perish over time — especially if an appliance has been moved or hasn&rsquo;t been serviced in years.</p>

              <h3 className="font-logo font-bold text-lg mb-2 mt-6" style={{ color: "var(--color-dark)" }}>Unlicensed gas work</h3>
              <p>In Australia, all gas fitting must be done by a licensed gas fitter. Unlicensed gas work is illegal and dangerous — poorly fitted connections are a common cause of leaks.</p>

              <h3 className="font-logo font-bold text-lg mb-2 mt-6" style={{ color: "var(--color-dark)" }}>Ground movement or external damage</h3>
              <p>Significant ground movement — or accidental damage from digging in the garden — can stress gas pipes at their joints. If you&rsquo;ve had earthworks near your property, have your gas infrastructure checked.</p>

              <hr className="border-gray-200 my-8" />

              <h2 id="safety-checks" className="font-logo font-bold text-2xl mb-4" style={{ color: "var(--color-dark)" }}>The Importance of Regular Gas Safety Checks</h2>
              ...
              <p className="mt-4">Most gas safety professionals recommend a check every two years, or annually for older properties.</p>

              <hr className="border-gray-200 my-8" />

              <h2 id="faq" className="font-logo font-bold text-2xl mb-6" style={{ color: "var(--color-dark)" }}>Frequently Asked Questions</h2>
              <div className="space-y-4">
                {[
                  ["How do I know if it's actually a gas leak?", "The rotten egg or sulphur smell is the most reliable indicator. If you smell it near a gas appliance, pipe, or meter — even faintly — treat it as a gas leak."],
                  ["Is a small or slow gas leak dangerous?", "Yes. Even a minor leak can allow gas to accumulate in an enclosed space over time, creating a risk of fire, explosion, or carbon monoxide poisoning."],
                  ["Can I repair a gas leak myself?", "No. All gas fitting work in Australia must be carried out by a licensed gas fitter. Attempting to repair a gas leak yourself is illegal and extremely dangerous."],
                  ["How much does a gas leak repair cost?", "A simple connection repair typically costs between $150 and $350. More complex repairs can range from $400 to over $1,000 depending on extent."],
                  ["My gas appliance was installed by a handyman — is it safe?", "This is a real risk. Only licensed gas fitters can legally install or service gas appliances. Have it inspected as soon as possible."],
                ].map(([q, a]) => (
