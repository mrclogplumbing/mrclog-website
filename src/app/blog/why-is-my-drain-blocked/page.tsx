...
export const metadata: Metadata = {
  title: pageTitle("Why Is My Drain Blocked? The Most Common Causes"),
  description:
...
const tocItems = [
  { id: "causes", title: "The 5 Most Common Causes" },
  { id: "warning-signs", title: "Warning Signs" },
  { id: "diy", title: "Can You Fix It Yourself?" },
  { id: "when-to-call", title: "When to Call a Plumber" },
  { id: "prevention", title: "How to Prevent Blockages" },
  { id: "faq", title: "FAQs" },
];
        ...
        <div className="relative section-container py-12 md:py-18">
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xs" style={{ color: "rgba(255,255,255,0.5)" }}>7 April 2026 · 5 min read</span>
            </div>
        ...
        <div className="lg:grid lg:grid-cols-[1fr_220px] lg:gap-12 max-w-5xl mx-auto">
          ...
          <article>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              ...
              <h2 id="causes" className="font-logo font-bold text-2xl mt-10 mb-4" style={{ color: "var(--color-dark)" }}>The 5 Most Common Causes of Blocked Drains</h2>
              ...
              <p>Tree roots are naturally drawn to the moisture and nutrients inside underground pipes. Over time, fine root fibres find tiny cracks or joints in older pipes and begin growing inside them — eventually causing a partial or complete blockage, or even cracking the pipe itself.</p>
              <p>If you have large trees near your home and notice recurring slow drains or gurgling sounds from multiple fixtures at once, tree roots may be the cause. This needs professional assessment with a CCTV drain camera.</p>

              <h3 className="font-logo font-bold text-lg mb-2 mt-8" style={{ color: "var(--color-dark)" }}>4. Foreign Objects</h3>
              <p>Children&rsquo;s toys, cotton buds, sanitary products, &ldquo;flushable&rdquo; wipes, and dental floss are among the most common items retrieved from blocked drains. Despite what the packaging says, most &ldquo;flushable&rdquo; products don&rsquo;t break down properly in Australian plumbing systems.</p>

              <h3 className="font-logo font-bold text-lg mb-2 mt-8" style={{ color: "var(--color-dark)" }}>5. Damaged or Collapsed Pipes</h3>
              <p>In older homes, pipes can corrode, crack, shift, or collapse over time — particularly clay or cast iron. If blockages keep coming back despite clearing them, a damaged pipe may be the underlying cause.</p>

              <hr className="border-gray-200 my-8" />

              <h2 id="warning-signs" className="font-logo font-bold text-2xl mb-4" style={{ color: "var(--color-dark)" }}>Warning Signs You Have a Blocked Drain</h2>
              ...
              <h2 id="diy" className="font-logo font-bold text-2xl mb-4" style={{ color: "var(--color-dark)" }}>Can You Unblock a Drain Yourself?</h2>
              <p>For minor blockages — particularly hair in a shower drain or a slow-draining bathroom sink — try these before calling a plumber:</p>
              ...
              <div className="rounded-xl p-4 text-sm mt-4" style={{ background: "#fff3cd", borderLeft: "4px solid #ffc107" }}>
                <strong>A word of caution:</strong> Avoid chemical drain cleaners regularly — they can corrode your pipes over time. For persistent blockages, professional clearing is always safer.
              </div>

              <hr className="border-gray-200 my-8" />

              <h2 id="when-to-call" className="font-logo font-bold text-2xl mb-4" style={{ color: "var(--color-dark)" }}>When to Call a Licensed Plumber</h2>
              <ul className="space-y-2">
                {[
              ...
              <h2 id="prevention" className="font-logo font-bold text-2xl mb-4" style={{ color: "var(--color-dark)" }}>How to Prevent Blocked Drains</h2>
              <ul className="space-y-2">
                {[
              ...
              <div className="space-y-4">
                {[
                  ["Can a blocked drain fix itself?", "Minor blockages sometimes clear on their own, but most don't. Address slow drainage early — a full blockage is much harder and more expensive to clear."],
                  ["How much does it cost to unblock a drain in Australia?", "A standard drain unblock typically costs between $150 and $400, depending on severity, location, and equipment needed."],
                  ["Why does my drain keep blocking in the same spot?", "Repeated blockages usually point to an underlying issue — pipe collapse, tree root intrusion, or incorrect pipe grade. A CCTV inspection will find the cause."],
                  ["Is it safe to use chemical drain cleaners?", "Use them sparingly. They're harsh on pipes and bad for the environment. Avoid entirely on older or PVC pipes."],
                  ["How do I know if it's a main sewer line blockage?", "If multiple drains are slow or backing up simultaneously — toilets, sinks, shower — it's likely a main sewer issue. Call a licensed plumber urgently."],
                ].map(([q, a]) => (
