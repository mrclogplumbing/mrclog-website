    ...
    <section className="section-padding" style={{ background: "var(--color-grey-100)" }}>
      <div className="section-container">
        ...
        <div className="flex items-center justify-center gap-3 mb-10">
          ...
          <span style={{ color: "var(--color-grey-600)" }} className="text-sm">Google Rating</span>
        </div>
        ...
        <div className="mt-10 rounded-2xl p-8 text-center" style={{ background: "rgba(26,159,255,0.06)", border: "1px solid rgba(26,159,255,0.2)" }}>
            <div className="flex items-center justify-center gap-1 mb-2">
              {[1,2,3,4,5].map(i => <StarIcon key={i} size={20} />)}
            </div>
            <p className="font-logo font-bold text-3xl mb-0.5" style={{ color: "var(--color-dark)" }}>5.0</p>
            <p className="text-sm text-gray-500 mb-5">Google Rating</p>
            <a
